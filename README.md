...
### Performance on Another Dataset
  ...
  For this experiment, we utilized [milistu/amazon-esci-data](https://huggingface.co/datasets/milistu/amazon-esci-data). From this dataset, we specifically selected queries that were in English and closely aligned with the corresponding product descriptions.
...
## Authors
- Mentor: [Milutin Studen](https://github.com/milistu)
- [Andjela Radojevic](https://github.com/andjela-r)
- [Petar Surla](https://github.com/petarSuki)
